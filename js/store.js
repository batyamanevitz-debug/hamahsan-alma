...
(function (window) {
  ...
  Store.products = [
    ...
    /* --- איפור וטיפוח --- */
    { id:'loreal-freshwear', brand:'L’ORÉAL PARIS', name:'פאונדיישן Infallible Fresh Wear', latin:'Infallible Fresh Wear Foundation',
    ...
    { id:'alma-highlighter', brand:'ALMA BEAUTY', name:'פלטת היילייטר', latin:'Glow Highlighter Palette',
    ...
    { id:'laroche-cicaplast', brand:'LA ROCHE-POSAY', name:'סיקהפלסט באלם B5', latin:'Cicaplast Baume B5',
    ...
    { id:'joseon-glow', brand:'BEAUTY OF JOSEON', name:'סרום אורז Glow Deep', latin:'Glow Deep Serum Rice + Alpha Arbutin',
    ...
    { id:'alma-mini-set', brand:'ALMA', name:'סט טיפוח מיני לנסיעות', latin:'Mini Travel Skincare Set',
    ...
    { id:'bloomfield-lavender', brand:'BLOOMFIELD', name:'מארז לבנדר 6 חלקים', latin:'Goodnight Sleep Bath Set',
    ...
    /* --- הכל לשיער --- */
    { id:'labeaute-duo', brand:'LA BEAUTE', name:'שמפו ומרכך קרטין וארגן', latin:'Keratin & Argan Duo',
    ...
    { id:'alma-best-set', brand:'ALMA', name:'מארז The Best of Alma', latin:'The Best of Alma Beauty Bag',
    ...
    { id:'cortex-box', brand:'CORTEX BEAUTY', name:'מארז עיצוב שיער', latin:'Styling Gift Box',
    ...
    { id:'labeaute-curls', brand:'LA BEAUTE', name:'קרם הגדרת תלתלים', latin:'Curl Defining Cream',
